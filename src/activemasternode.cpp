...
// Copyright (c) 2017 Empinel / The MTNC Developers
// Copyright (c) 2017 Empinel / The Masternodecoin Developers
...
//
// Bootup the masternode, look for a 50000 MTNC input and register on the network
//
void CActiveMasternode::ManageStatus()
{
    ...
    if(status == MASTERNODE_NOT_PROCESSED) {
        ...
        if(GetMasterNodeVin(vin, pubKeyCollateralAddress, keyCollateralAddress)) {
            ...
            /* donations are not supported in Masternodecoin.conf */
