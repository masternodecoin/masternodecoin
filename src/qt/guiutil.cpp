...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Masternodecoin.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Name=Masternodecoin\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Masternodecoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Masternodecoin-Qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Masternodecoin-Qt"));
