...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw runtime_error(
                ...
                "  stop         - Stop masternode configured in Masternodecoin.conf\n"
...
Value masternodelist(const Array& params, bool fHelp)
{
				...
				&& strMode != "score"))
    {
        throw runtime_error(
                ...
                "  votes          - Print all masternode votes for a Masternodecoin initiative (can be additionally filtered, partial match)\n"
